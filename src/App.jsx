...
function PullQuote({ children, dark = false }) {
  return (
    <blockquote className="reveal reveal-delay-2" style={{
      borderLeft: `4px solid ${C.sienna}`,
      paddingLeft: 24, marginLeft: 0,
      marginTop: 40, marginBottom: 40,
    }}>
      <p style={{
        fontFamily: "'Playfair Display', serif", fontStyle: "italic",
        fontSize: "clamp(20px, 2.8vw, 28px)", lineHeight: 1.65,
...
// ─── CHARRETTE IMAGE ─────────────────────────────────────────────────────────
function CharretteImage({ src, alt, caption, dark = false }) {
  return (
    <div className="reveal" style={{
      marginTop: 48, marginBottom: 40,
    }}>
      <div style={{
        borderTop: `2px solid ${C.sienna}`,
        marginBottom: 16,
      }} />
...
function VisionSection({ onRespond }) {
  return (
    <SectionWrapper id="vision">
      ...
      <SectionSub>Three days. Five firms. One direction.</SectionSub>
      <Rule />
      ...
      <div style={{ marginBottom: 36 }}>
        <div className="reveal" style={{
          borderLeft: `4px solid ${C.sienna}`,
          padding: "24px 28px",
          background: C.parchmentAlt,
          marginBottom: 24,
        }}>
          <p style={{
            fontFamily: "'DM Sans', sans-serif", fontSize: 11, letterSpacing: "0.12em",
            textTransform: "uppercase", color: C.sienna, fontWeight: 600, marginBottom: 12,
          }}>01 — Lost and Found</p>
          <p style={{
            fontFamily: "'Lora', serif", fontSize: "clamp(15px, 1.6vw, 17px)",
            lineHeight: 1.92, color: C.ink,
          }}>You cross the bridge and the city disappears. Every building sits low. Every roofline stays below the tree canopy. There are no landmarks to orient yourself by and that is the point. Twenty minutes from downtown Dallas, you cannot tell where you are. The peninsula becomes its own world: quiet, open, surrounded by water on nearly every side. The feeling of being lost is not a failure of wayfinding. It is the product.</p>
        </div>
        ...
        <div className="reveal" style={{
          ...
          <p style={{
            fontFamily: "'Lora', serif", fontSize: "clamp(15px, 1.6vw, 17px)",
            lineHeight: 1.92, color: C.ink,
          }}>This is a golf property. Not a resort that happens to have golf. Not an entertainment district with courses attached. Every dollar, every square foot, every design decision serves the game first. Two championship courses. A world-class practice facility. An academy. A short course. A par-three park. The crescendo moves from accessible to aspirational: beginners on The Patch, serious players on the range, everyone finishing in the stadium. Accommodations exist to support the golf, not the other way around.</p>
        </div>
        ...
        <div className="reveal" style={{
          ...
          <p style={{
            fontFamily: "'DM Sans', sans-serif", fontSize: 11, letterSpacing: "0.12em",
            textTransform: "uppercase", color: C.sienna, fontWeight: 600, marginBottom: 12,
          }}>03 — Member for a Day</p>
          <p style={{
            fontFamily: "'Lora', serif", fontSize: "clamp(15px, 1.6vw, 17px)",
            lineHeight: 1.92, color: C.ink,
          }}>This is not a private club. It is not a corporate resort. It is something rarer: a public destination that feels like you belong here. The stadium finish puts strangers in the same conversation. The inn puts you in the clubhouse where the action is. The starter shacks have personality. The caretaker's cottage knows your name. Every touchpoint is designed so that a first-time visitor feels the same warmth and ownership that a founding member would. You came for the golf. You come back for the feeling.</p>
        </div>
      </div>

      <CharretteImage src="/charrette/master-plan.jpg" alt="Conceptual Master Plan" caption="Conceptual Master Plan — Charrette Chosen Direction" />
      ...
      <TwoCol
        left={<>
          <SubHead>Zone 01 — The Arrival</SubHead>
          <Body>The first face-to-face moment matters more than anything we design. The caretaker's cottage is not a gate. It is a small, intimate building where guests are welcomed by name, oriented to the property, and sent on their way with the story already beginning. There is no barrier, no credential check, no formal security presence. There is a person in a comfortable room who knows you are coming and is glad you arrived. Beyond it, The Patch and a potential waterfront dining district establish the project's public face. This is the zone that says: we are about golf, and everyone is welcome.</Body>
        </>}
        right={<>
          <CharretteImage src="/charrette/cottage-rendering.jpg" alt="The Caretaker's Cottage" caption="The Caretaker's Cottage" />
        </>}
      />

      <TwoCol
        left={<>
          <SubHead>Zone 02 — The Village</SubHead>
          <Body>The village is where the property comes alive. Positioned on high ground above the floodplain, it clusters the functions that generate daily energy: a circular practice facility roughly 300 yards across, two short game areas, and a pair of starter shacks that double as halfway houses for returning nines. One serves burgers and beer. The other serves tacos and margaritas. The difference is intentional. Two distinct personalities, two reasons to come back tomorrow. Flanking the practice area are an academy with six teaching bays and simulators, a future wellness center, and an admin building with a rooftop gathering space we are calling The Perch. The entire village can begin with two buildings and grow as the market responds. Phase 1 builds only what is necessary.</Body>
        </>}
        right={<>
          <CharretteImage src="/charrette/village-rendering.jpg" alt="The Village — Aerial View" caption="The Village — Aerial View" />
        </>}
      />

      <TwoCol
        left={<>
          <SubHead>Zone 03 — The Heart of the Course</SubHead>
          <Body>The clubhouse sits where the spine meets the water. Entering from above, guests look through the building and see 180 degrees of Joe Pool Lake. Below, two eighteenth greens converge in a natural amphitheater. This is the stadium finish: the moment the round becomes a shared event.</Body>
          <Body>The 19th hole, locker rooms, pro shop, merchandise, and cart staging all consolidate here. Everything a golfer needs before and after the round lives under one roof.</Body>
          <Body>Phase 1 programs approximately 22,000 square feet of conditioned space with eight sleeping rooms tucked into the lower level. These are not hotel suites. They are simple rooms: two beds, a mini-fridge, a place to hang clothes. Guests share the communal wet areas all connected to the locker room. The presence of overnight guests keeps the property alive after dark, tests accommodation demand, and signals to early visitors what this place will become.</Body>
        </>}
        right={<>
          <CharretteImage src="/charrette/clubhouse-rendering.jpg" alt="The Clubhouse & Inn" caption="The Clubhouse & Inn" />
        </>}
      />

      <PullQuote>You arrive curious. You leave converted.</PullQuote>

      <CharretteImage src="/charrette/spirit-of-place.jpg" alt="The Spirit of the Place" caption="The Spirit of the Place" />

      <FeedbackPrompt
        question="What from the charrette resonates most with you? What aspect of this direction deserves deeper development?"
        onRespond={onRespond}
      />
    </SectionWrapper>
  );
  ...
  return (
    <section id="loop" style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <SectionLabel number="07" label="The Loop" dark />
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 16, marginBottom: 20 }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, letterSpacing: "0.1em", color: "rgba(245,240,232,0.28)", textTransform: "uppercase" }}>Work Architecture · Version 2.0 · April 2026</p>
        ...
        <p style={{ fontFamily: "'Lora', serif", fontStyle: "italic", fontSize: 12, color: "rgba(245,240,232,0.22)", lineHeight: 1.75 }}>
          This portal was built by Work Architecture as a living intelligence document for the Estes Park design charrette, March 31 – April 2, 2026. It will be updated as the project evolves. Version 2.0.
        </p>
      </div>
    </footer>
  );
...
export default function App() {
  ...
  useEffect(() => {
    const sections = ["story", "place", "market", "comps", "vision", "team", "loop"];
    const obs = new IntersectionObserver(
